...
/* =====================================================================
   ...
   每张照片是一段 { src, title, date, desc }：
     src   ：图片路径。把你的照片放进 assets/images/ 文件夹，
             再把这里的文件名改成你的，比如 "assets/images/我们的海边.jpg"
     title ：标题（比如「一起去的海边」）
   ...
   ===================================================================== */
const PHOTOS = [
  { src: "assets/images/photo-1.jpg", title: "相遇在晚霞里", date: "2024.12.05", desc: "那道粉紫色的晚霞会永远陪你回家" },
  { src: "assets/images/photo-2.jpg", title: "第一次一起旅行", date: "2024.12.16", desc: "紧张但幸福的一场梦" },
  { src: "assets/images/photo-3.jpg", title: "每周都有的小小约会", date: "2025.01.25", desc: "皮衣小姐永远闪亮登场" },
  { src: "assets/images/photo-4.jpg", title: "最难忘的生日呀", date: "2025.05.27", desc: "火山上的星星会实现你的心愿" },
  { src: "assets/images/photo-5.jpg", title: "我的宝宝毕业啦", date: "2026.07.03", desc: "一起走向更远的未来吧" },
];
...
/* =====================================================================
   ...
   每部电影是一段 { poster, title, date, rating, note }：
     poster ：海报图片路径（放进 assets/images/，再改文件名）
     title  ：电影名
     date   ：你们看它的日期
     rating ：几颗心（1–5，填数字）
     note   ：关于这次一起看的一句话
   ...
   ===================================================================== */
const MOVIES = [
  { poster: "assets/images/movie-1.jpg", title: "机器人之梦", date: "", rating: 5, note: "今天要去沙滩找机器人吗?" },
  { poster: "assets/images/movie-2.jpg", title: "喜人奇妙夜",     date: "", rating: 5, note: "爱屋及乌的颜小葵被喜剧感动成了泪人" },
  { poster: "assets/images/movie-3.jpg", title: "我可以47",         date: "", rating: 4, note: "雌鹰一般的女人绝不认输！！" },
  { poster: "assets/images/movie-4.jpg", title: "这就是灌篮",       date: "", rating: 4, note: "打了一辈子篮球，姐姐精准命中我的篮筐" },
  { poster: "assets/images/movie-5.jpg", title: "我许可",   date: "", rating: 5, note: "永远做最自信最自由的女孩呀" },
];
...
/* =====================================================================
   ...
   每一天是一段 { date, pig, bunny }：
     date  ：这一天的日期
     pig   ：小猪那一页 { text: "想说的话", img: "assets/images/图片.jpg" }
     bunny ：小兔那一页 { text: "想说的话", img: "assets/images/图片.jpg" }
   img 可留空 ""，那一页就只有文字。
...
const DIARY = [
  { date: "",
    pig:   { text: "今天健身很累，但一看到你就很开心！谢谢你一直陪着我。", img: "assets/images/diary-1a.jpg" },
    bunny: { text: "每天都吃小猪饭饭，超级好吃！你是最棒的厨师～",     img: "assets/images/diary-1b.jpg" } },
  { date: "",
    pig:   { text: "我特别喜欢听你说话，每一句都很珍贵，永远不会嫌你话多。",               img: "assets/images/diary-2a.jpg" },
    bunny: { text: "和你在一起的时候感觉有种很安静的幸福。",   img: "assets/images/diary-2b.jpg" } },
  { date: "",
    pig:   { text: "虽然不在一起，我也会给姐姐拍照，和小兔待在一起。",     img: "assets/images/diary-3a.jpg" },
    bunny: { text: "你是我最好的朋友，最亲密的家人，也是我托付一生的恋人。",                   img: "assets/images/diary-3b.jpg" } },
];
...
/* =====================================================================
   ...
   把歌曲文件放进 assets/music/ 文件夹，
   再把文件名照下面的格式写进来，一行一首：

     "assets/music/theme.mp3",
     "assets/music/我们的歌.mp3",
...
const MUSIC = [
  "assets/music/大雨.mp3",
  "assets/music/这条小鱼在乎.mp3",
  "assets/music/滥俗的歌.mp3",
  "assets/music/思念.mp3",
  "assets/music/这世界那么多人.mp3",
  "assets/music/寂寞烟火.mp3",
  "assets/music/星空.mp3",
  "assets/music/约会在星期天晚上.mp3",
];
